...
class Story664(GenericTest):
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc01')
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc02')
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc03', 'cdb_priority1')
    def test_03_p_create_update_remove_logrotate_rules(self):
        ...
        try:
            ...
            self.assertEqual("size {0}k".format(rotate), logfile[7])
            ...
            props = "compress='true' rotate='{0}'".format(rotate + 1)
            ...
            self.assertEqual("nodelaycompress", logfile[5])
            self.assertEqual("rotate {0}".format(rotate + 1), logfile[6])
            self.assertEqual("size {0}k".format(rotate), logfile[7])
            ...
            outlist = self.list_dir_contents(
                self.test_node1, logfile_path,
                su_root=True, grep_args=logfilename + ".*.gz")
            self.assertEqual(rotate + 1, len(outlist))
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc04')
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc05')
...
.           #step:     Check file contents for configuration settings applied
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc06')
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc07')
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc08')
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc09')
    ...
    @attr('pre-reg', 'revert', 'story664', 'story664_tc10')
